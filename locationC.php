...
include ('dbconfig.php');
	...
	echo '<select id="Cbo_Location" class="select" name="Cbo_Location" onchange="showQtyC(this.value)">';
	echo '<option class="select" value="0" selected disabled>請選擇地點...</option>';
