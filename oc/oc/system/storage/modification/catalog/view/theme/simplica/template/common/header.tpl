...
#search .btn, #menu .btn-navbar, .btn-primary{
    background: <?php echo $moustylecolor2; ?>;
}
#search .btn-lg, #cart > .btn, .product-thumb .button-group button {
    color: <?php echo $moustylecolor3; ?>;
}
...
#box-featured, #box-lastest{
	background-color: <?php echo $moustylecolor; ?>;
	min-height: 40px;
...
#box-special, #box-bestseller{
	background: <?php echo $moustylecolor3; ?>;
    border-radius: 4px 4px 0px 0px;
}
...
<li><a href="index.htm"><?php echo $text_home; ?></a></li>
