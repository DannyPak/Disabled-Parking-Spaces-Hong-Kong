...
class ControllerExtensionThemeThemeDefault extends Controller {
	...
	public function index() {
		...
		$data['heading_title'] = $this->language->get('heading_title');
           ...
           $data['text_mou_style_title'] = $this->language->get('text_mou_style_title');
           $data['text_mou_style_title2'] = $this->language->get('text_mou_style_title2');
           $data['text_mou_style_title3'] = $this->language->get('text_mou_style_title3');

           $data['help_mou_style_title'] = $this->language->get('help_mou_style_title');
           $data['help_mou_style_title2'] = $this->language->get('help_mou_style_title2');
           $data['help_mou_style_title3'] = $this->language->get('help_mou_style_title3');
		...
		foreach ($directories as $directory) {
			$data['directories'][] = basename($directory);
                   ...
                   if (isset($this->request->post['theme_default_moustylecolor'])) {
			$data['theme_default_moustylecolor'] = $this->request->post['theme_default_moustylecolor'];
		} elseif (isset($setting_info['theme_default_moustylecolor'])) {
			$data['theme_default_moustylecolor'] = $setting_info['theme_default_moustylecolor'];
		} else {
			$data['theme_default_moustylecolor'] = '';
		}


        if (isset($this->request->post['theme_default_moustylecolor2'])) {
			$data['theme_default_moustylecolor2'] = $this->request->post['theme_default_moustylecolor2'];
		} elseif (isset($setting_info['theme_default_moustylecolor2'])) {
			$data['theme_default_moustylecolor2'] = $setting_info['theme_default_moustylecolor2'];
		} else {
			$data['theme_default_moustylecolor2'] = '';
		}


        if (isset($this->request->post['theme_default_moustylecolor3'])) {
			$data['theme_default_moustylecolor3'] = $this->request->post['theme_default_moustylecolor3'];
		} elseif (isset($setting_info['theme_default_moustylecolor3'])) {
			$data['theme_default_moustylecolor3'] = $setting_info['theme_default_moustylecolor3'];
		} else {
			$data['theme_default_moustylecolor3'] = '';
		}
