          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-text_mou_style_title"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_mou_style_title; ?>"><?php echo $text_mou_style_title; ?></span></label>
                 <div class="col-sm-10">
                  <input type="text" name="theme_default_moustylecolor" value="<?php echo $theme_default_moustylecolor; ?>"  id="input-theme_default_moustylecolor" size="6" class="color {required:false,hash:true}" />
                 </div>
             </div>

             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-text_mou_style_title"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_mou_style_title2; ?>"><?php echo $text_mou_style_title2; ?></span></label>
                 <div class="col-sm-10">
                  <input type="text" name="theme_default_moustylecolor2" value="<?php echo $theme_default_moustylecolor2; ?>"  id="input-theme_default_moustylecolor2" size="6" class="color {required:false,hash:true}" />
                 </div>
             </div>

             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-text_mou_style_title3"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_mou_style_title3; ?>"><?php echo $text_mou_style_title3; ?></span></label>
                 <div class="col-sm-10">
                  <input type="text" name="theme_default_moustylecolor3" value="<?php echo $theme_default_moustylecolor3; ?>"  id="input-theme_default_moustylecolor3" size="6" class="color {required:false,hash:true}" />
                 </div>
             </div>
