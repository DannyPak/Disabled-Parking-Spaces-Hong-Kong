...
class ControllerPaymentAlipayTransfer extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/alipay_transfer.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/alipay_transfer.tpl', $data);
		} else {
			return $this->load->view('default/template/payment/alipay_transfer.tpl', $data);
		}
	}
