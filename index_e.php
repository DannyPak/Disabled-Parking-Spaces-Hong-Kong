<html>
	...
	<!-- Google Maps and Places API -->
		...
		<script async defer src="https://maps.googleapis.com/maps/api/js?v=3.23&key=AIzaSyAtIgD391Vv6rhDJJ_56AWADgTHXqcZNG4"
...
<script>
	...
	<nav>
		...
		<div id="txtBtn" class="leftContent">
			<div id="sch-btn"><button type="button" id="schbutton" class="hidden schbtn" onclick="geocode()">SEARCH</button></div>
		</div>
	...
	<div id="splash">					
		<div id="masthead">
			<div id="inner">
				<div id="header">
					...
					<img id="tc" alt="TC" src="img/tc.png" >
		...
		<div id="go-btn"><button type="button" id="gobutton" class="hidden btn" onclick="gotomap()">View on GOOGLE MAPS</button></div>
		<div id="str-btn"><button type="button" id="strbutton" class="hidden btn" onclick="panoview()">STREET VIEW</button></div>
		<div id="map-btn"><button type="button" id="mapbutton" class="hidden btn" onclick="geocode()">ROAD MAP</button></div>
		</div>
